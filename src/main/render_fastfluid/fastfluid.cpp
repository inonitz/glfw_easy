    ...
    while(alive)
    {
        ...
        if(!paused) 
        {
            ...
            while(lag >= ns_per_update) {
                ...
                Encapsulate::update(globalState);
...
void Encapsulate::glState::prepare(math::vec2i const& sim_bounds) 
{
...
void Encapsulate::glState::destroy()
{
...
void Encapsulate::update(__unused ProgramState& state) {
    return;
}
