...
template<typename T> using ref 		 = typename detail::__conditional_operator<sizeof(T) <= 8, T, T&		>::type;
template<typename T> using const_ref = typename detail::__conditional_operator<sizeof(T) <= 8, T, T const&>::type;
template<typename T> using value_ptr = typename detail::__conditional_operator<sizeof(T) <= 8, T, T*>::type;
